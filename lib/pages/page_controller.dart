...
class CustomPageController extends ConsumerStatefulWidget {
  const CustomPageController({super.key});

  @override
  ConsumerState<CustomPageController> createState() => _MyAppState();
}

class _MyAppState extends ConsumerState<CustomPageController> {
